    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-5">
                ...
                <div class="col-12 mt-3">
                    @ifset( $_SESSION['contact-details-error'] )
                        <p class="alert alert-danger" role="alert"> {{ $_SESSION['contact-details-error'] }} </p>
                    @endif
                </div>
            ...
            <div class="col-12 mt-5">
                ...
                @foreach( $data['contacts'] as $contact )
                    <div class="row mb-2">
                        <div class="col-9">{{ $count }} {{ $contact['name'] }} : {{ $contact['contact'] }} ( {{ $contact['designation'] }} )  </div>
                        <div class="col-3"><a href="/delete-contact?id={{ $contact['id'] }}&csrf={{ $_SESSION['csrf_token'] }}" class="btn btn-danger">Delete</a></div>
                    </div>
