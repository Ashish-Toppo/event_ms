    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-5">
                ...
                <div class="col-12 mt-3">
                    @ifset( $_SESSION['create-awards-error'] )
                        <p class="alert alert-danger" role="alert"> {{ $_SESSION['create-awards-error'] }} </p>
                    @endif
                </div>
            ...
            <div class="col-12 mt-5">
                ...
                @foreach( $data['awards'] as $award )
                    <div class="row mb-2">
                        <div class="col-9"> <b> {{ $count }}.</b> {{ $award['name'] }} --- &gt;  ( {{ $award['no_of_awards'] }} )  </div>
                        <div class="col-3"><a href="/delete-award?id={{ $award['id'] }}&csrf={{ $_SESSION['csrf_token'] }}" class="btn btn-danger">Delete</a></div>
                    </div>
