                ...
                <div class="row d-flex flex-column p-3">
                    ...
                    <div class="outer-border">
                        <div class="inner-dotted-border">
                            ...
                            <br><br>
                            <span class="name"><b> <?php echo  $data['winner_name'] ; ?> </b></span><br/><br/>
                            ...
                            <span class="fs-30"><b> <?php echo  $data['prize_name'] ; ?> </b></span> <br/><br/>
                            <span class="fs-20"> certificate No: <?php echo  $data['certificate_no'] ; ?> <b></b></span> <br>
