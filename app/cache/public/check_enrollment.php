        ...
        <div class="row">
            ...
            <main class="col-md-9 col-sm-12">
                <div class="row d-flex flex-column p-3">
                    ...
                    <form method="get" action="/enrollment-certificate">
                        
                        <div class="my-2">
                            <h2 class="center"> Check Enrollment Details </h2>
                            <p></p>
                        </div>
                        <div class="mb-3">
                            <label for="id" class="form-label">Enrollment (Registration) No. </label>
