                ...
                <div class="row d-flex flex-column p-3">
                    ...
                    <div class="outer-border">
                        <div class="inner-dotted-border">
                            ...
                            <br><br>
                            <span class="name"><b> <?php echo  $data['details']['name'] ; ?> </b></span><br/><br/>
                            <span class="certify"><i>has successfully registered for the event </i></span> <br/><br/>
                            <span class="fs-30"><b> <?php echo  $data['event_name'] ; ?> </b></span> <br/><br/>
                            <span class="fs-20"> Registration No: <?php echo  $data['enrollment_no'] ; ?> <b></b></span> <br/><br/><br/><br/>
                            <span class="certify">
                                <i>
                                    Registration Fee: <?php echo  $data['enrollment_charges'] ; ?>

                                    <?php if($data['details']['fee_payment'] == 0): ?>
                                        (unpaid)
                                    <?php elseif($data['details']['fee_payment'] == 1): ?>
                                        (paid)
                                    <?php endif; ?>
                            ...
                            <span class="fs-30">Date: <?php echo  $data['details']['date'] ; ?> </span>
...
<script>
    ...
    jQuery(document).ready(function($){
        ...
        jQuery('#PayNow').click(function(e){
            ...
            var paymentOption='';
            let billing_name = '<?php echo  $data['details']['name'] ; ?>';
