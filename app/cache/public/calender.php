...
<body>
  ...
  <script type="text/tmpl" id="tmpl">
    ...
    <table class="calendar-table table table-condensed table-tight">
            ...
            <table style="white-space: nowrap; width: 100%">
              <tr>
                <td style="text-align: left;">
                  ...
                  <button class="js-cal-option btn btn-default <?php echo  first.toDateInt() <= today.toDateInt() && today.toDateInt() <= last.toDateInt() ? 'active':'' ; ?>" data-date="<?php echo  ; ?>" data-mode="month"><?php echo  todayname ; ?></button>
                </td>
                <td>
                  <span class="btn-group btn-group-lg">
                    <?php echo  if (mode !== 'day') { ; ?>
                    <?php echo  if (mode === 'month') { ; ?><button class="js-cal-option btn btn-link" data-mode="year"><?php echo  months[month] ; ?></button><?php echo  } ; ?>
                    <?php echo  if (mode ==='week') { ; ?>
                    <button class="btn btn-link disabled"><?php echo  shortMonths[first.getMonth()] ; ?> <?php echo  first.getDate() ; ?> - <?php echo  shortMonths[last.getMonth()] ; ?> <?php echo  last.getDate() ; ?></button>
                    <?php echo  } ; ?>
                    <button class="js-cal-years btn btn-link"><?php echo  ; ?></button>
                    <?php echo  } else { ; ?>
                    <button class="btn btn-link disabled"><?php echo  date.toDateString() ; ?></button>
                    <?php echo  } ; ?>
                  </span>
                </td>
                <td style="text-align: right">
                  <span class="btn-group">
                    <button class="js-cal-option btn btn-default <?php echo  mode==='year'? 'active':'' ; ?>" data-mode="year">Year</button>
                    <button class="js-cal-option btn btn-default <?php echo  mode==='month'? 'active':'' ; ?>" data-mode="month">Month</button>
                    <button class="js-cal-option btn btn-default <?php echo  mode==='week'? 'active':'' ; ?>" data-mode="week">Week</button>
                    <button class="js-cal-option btn btn-default <?php echo  mode==='day'? 'active':'' ; ?>" data-mode="day">Day</button>
                  </span>
                </td>
              </tr>
            </table>
      ...
      <tbody>
        <?php echo  for (j = 0; j < 3; j++) { ; ?>
        <tr>
          <?php echo  for (i = 0; i < 4; i++) { ; ?>
          <td class="calendar-month month-<?php echo  js-cal-option" data-date="{{: new Date(year, month, 1).toISOString() ; ?>" data-mode="month">
      ...
      <?php echo  } ; ?>
      <?php echo  if (mode ==='month' || mode ==='week') { ; ?>
      <thead>
        <tr class="c-weeks">
          <?php echo  for (i = 0; i < 7; i++) { ; ?>
          <th class="c-name">
            <?php echo  days[i] ; ?>
          </th>
          <?php echo  } ; ?>
      ...
      <tbody>
        <?php echo  for (j = 0; j < 6 && (j < 1 || mode === 'month'); j++) { ; ?>
        <tr>
          <?php echo  for (i = 0; i < 7; i++) { ; ?>
          <?php echo  if (thedate > last) { dayclass = nextmonthcss; } else if (thedate >= first) { dayclass = thismonthcss; } ; ?>
          <td class="calendar-day <?php echo  dayclass ; ?> <?php echo  thedate.toDateCssClass() ; ?> <?php echo  date.toDateCssClass() === thedate.toDateCssClass() ? 'selected':'' ; ?> <?php echo  daycss[i] ; ?> js-cal-option" data-date="<?php echo  thedate.toISOString() ; ?>">
            <div class="date"><?php echo  thedate.getDate() ; ?></div>
            <?php echo  thedate.setDate(thedate.getDate() + ; ?>
          </td>
          <?php echo  } ; ?>
        </tr>
        <?php echo  } ; ?>
          ...
          <td colspan="7">
            <table class="table table-striped table-condensed table-tight-vert">
              <thead>
                <tr>
                  <th>&nbsp;</th>
                  <th style="text-align: center; width: 100%"><?php echo  days[date.getDay()] ; ?></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th class="timetitle">All Day</th>
                  <td class="<?php echo  date.toDateCssClass() ; ?>"> </td>
                </tr>
                <tr>
                ...
                <?php echo  (i = 6; i < 22; i++) { ; ?>
                <tr>
                  <th class="timetitle"><?php echo  i <= 12 ? i : i - 12 ; ?> <?php echo  i < 12 ? "AM" : ; ?></th>
                  <td class="time-<?php echo  ; ?>-0"> </td>
                </tr>
                <tr>
                  <th class="timetitle"><?php echo  i <= 12 ? i : i - 12 ; ?>:30 <?php echo  i < 12 ? "AM" : ; ?></th>
                  <td class="time-<?php echo  ; ?>-30"> </td>
                </tr>
                <?php echo  } ; ?>
                <tr>
