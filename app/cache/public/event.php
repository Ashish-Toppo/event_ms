                        ...
                        <div class="col-12 time mt-3">
                            <table class="table table-bordered" id="event_time">
                                ...
                                <?php if($data['details']['one_day_event'] == 1): ?>
                                    <tr class="">
                                        <th colspan="2"> ON: <?php echo  $data['date']['date_on'] ; ?> </th>
                                    </tr>
                                    <tr>
                                        <td>Start</td>
                                        <td> <?php echo  $data['date']['time_from'] ; ?> </td>
                                    </tr>
                                    <tr>
                                        <td>End</td>
                                        <td> <?php echo  $data['date']['time_to'] ; ?> </td>
                                    </tr>
                                 ...
                                 <?php elseif($data['details']['one_day_event'] == 0): ?>
                                    <tr>
                                        <td>Start</td>
                                        <td> <?php echo  $data['date']['date_from'] ; ?> </td>
                                    </tr>
                                    <tr>
                                        <td>End</td>
                                        <td> <?php echo  $data['date']['date_to'] ; ?> </td>
                                    </tr>
                                <?php endif; ?>
