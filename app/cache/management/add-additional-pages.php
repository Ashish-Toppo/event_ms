        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <?php foreach($data['pages'] as $page): ?>
                                <div class="row mb-2">
                                    <div class="col-6"><b> <?php echo  $count ; ?> </b> <?php echo  $page['name'] ; ?>  </div>
                                    <div class="col-3"><a href="/page?id=<?php echo  $page['id'] ; ?>" class="btn btn-success">View</a></div>
                                    <div class="col-3"><a href="/delete-page?id=<?php echo  $page['id'] ; ?>&csrf=<?php echo  $_SESSION['csrf_token'] ; ?>" class="btn btn-danger">Delete</a></div>
                                </div>
            ...
            <div class="col-12 mb-5">
                ...
                <div class="col-12 mt-3">
                    <?php if ( isset( $_SESSION['add-pages-error'] ) ) : ?>
                        <p class="alert alert-danger" role="alert"> <?php echo  $_SESSION['add-pages-error'] ; ?> </p>
                    <?php endif; ?>
                </div>
                
                <form action="/add-page" method="POST" class="form">
                    <input type="hidden" name="csrf_token" value="60cea4c1fb697959f89f9321b0140b9e" />
