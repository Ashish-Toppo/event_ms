    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12 my-3">
                    ...
                    <tbody>
                        ...
                        <?php foreach($data['enrollments'] as $enrollment): ?> 
                            <tr>
                                ...
                                <td> <?php echo  $enrollment['phone'] ; ?> </td>
                                <td>
                                    <?php foreach($enrollment['additional_fields'] as $key => $value): ?>
                                        <b> <?php echo  $key ; ?> </b> : <?php echo  $value ; ?> <br>
                                    <?php endforeach; ?>
                                </td>
                                <td> <?php echo  $enrollment['enrollment_type'] ; ?> </td>
                                <td>
                                    <?php  $fee_paid = ($enrollment['fee_payment'] == 1) ? 1 : 0; ?>
                                    <?php if($fee_paid): ?>
                                        <b>Paid</b>
                                    <?php else: ?>
                                        <b>Not Paid</b>
                ...
                <?php if(!$data['event_ended']): ?>
                    <div class="row">
                        <div class="col-12">
                            <a href="/distribute-prizes?id=<?php echo  $data['event_id'] ; ?>" class="btn btn-success">Select Winners</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
