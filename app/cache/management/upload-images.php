        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                ...
                <?php foreach($data['images'] as $image): ?>
                    <div class="row mb-2">
                        <div class="col-6"><?php echo  $count ; ?> <?php echo  $image['image'] ; ?> </div>
                        <div class="col-6"><a href="<?php echo  $image['image'] ; ?>" class="btn btn-primary">View</a> <a href="/delete-image?id=<?php echo  $image['id'] ; ?>&csrf=<?php echo  $_SESSION['csrf_token'] ; ?>" class="btn btn-danger">Delete</a></div>
                    </div>
        ...
        canvas.toBlob(function(blob) {
            ...
            reader.onloadend = function() {
                ...
                $.ajax({
                    ...
                    data: {
                        image: base64data,
                        csrf: '8748fe4cc8c111104d0f8297e4ab7eaf'
                    },
