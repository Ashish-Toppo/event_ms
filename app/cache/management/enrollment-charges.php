    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-5">
                ...
                <div class="col-12 mt-3">
                    <?php if ( isset( $_SESSION['enrollment-details-error'] ) ) : ?>
                        <p class="alert alert-danger" role="alert"> <?php echo  $_SESSION['enrollment-details-error'] ; ?> </p>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-12 mt-5">
                <?php  $count = 1; ?>
                <?php foreach($data['det'] as $field): ?>
                    <div class="row mb-2">
                        <div class="col-9"><?php echo  $count ; ?>. <?php echo  $field['field_name'] ; ?> : <?php echo  $field['field_type'] ; ?>  </div>
                        <div class="col-3"><a href="/delete-added-field?id=<?php echo  $field['id'] ; ?>&csrf=<?php echo  $_SESSION['csrf_token'] ; ?>" class="btn btn-danger">Delete</a></div>
                    </div>
            ...
            <div class="col-12 mt-5">
                <?php  $count = 1; ?>
                <?php foreach($data['enType'] as $type): ?>
                    <div class="row mb-2">
                        <div class="col-9"><?php echo  $count ; ?>. <?php echo  $type['enrollment_type'] ; ?> => <?php echo  $type['enrollment_charges_curr'] ; ?> <?php echo  $type['enrollment_charges'] ; ?>   </div>
                        <div class="col-3"><a href="/delete-enrollment-type?id=<?php echo  $field['id'] ; ?>&csrf=<?php echo  $_SESSION['csrf_token'] ; ?>" class="btn btn-danger">Delete</a></div>
                    </div>
